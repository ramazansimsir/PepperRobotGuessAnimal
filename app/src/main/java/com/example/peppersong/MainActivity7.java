...
public class MainActivity7 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    com.example.peppersong.databinding.ActivityMain7Binding design;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        design= com.example.peppersong.databinding.ActivityMain7Binding.inflate(getLayoutInflater());
        // Register the RobotLifecycleCallbacks to this Activity
        setContentView(design.getRoot());
        QiSDK.register(this, this);
        mediaPlayer=MediaPlayer.create(MainActivity7.this,R.raw.kurt);
